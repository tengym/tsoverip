...
GOS_U16 CRC_crc16_table[CRC16_MAX_COEFFICIENTS];
GOS_U32 CRC_crc32_table[CRC32_MAX_COEFFICIENTS];
...
GOS_S32 GOS_CRC_Init(void)
{
 ...
 /******************************************************************************
 * Function Name : GOS_CRC_16bCalculate
 *
 * Description   :
 *
...
void GOS_CRC_16bCalculate(GOS_U8  *buffer, GOS_U32 size, GOS_U16 *CRC16)
{
 ...
 /******************************************************************************
 * Function Name : GOS_CRC_32bCalculate
 *
 * Description   :
 *
